...
public class AuthenticationConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeRequests()
                .antMatchers("/api/v1/users/join", "/api/v1/users/login", "/api/v1/users/duplicationcheck/nickname", "/api/v1/users/create/connectcode", "/swagger-ui.html/**","/kakao","/kakaoToken","/api/v1/file/file-system/**").permitAll() //join,loin은 언제나 허용한다.
